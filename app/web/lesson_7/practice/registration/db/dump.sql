...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_login_uindex` (`mail`),
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-01-23 13:06:01
